...
**स्थिति: मिड-v0 (v0.12.0) — सुरक्षा को मजबूत करने वाला संस्करण।** केवल सीपीयू पर आधारित। सत्यापनकर्ता SGD, Adam, AdamW और PyTorch-शैली SGD मोमेंटम (क्लासिक, नेस्टेरोव और डैम्पनिंग) को कवर करता है।
लाइव PyTorch सहायक (`scripts/extract/pytorch.py`) समान ऑप्टिमाइज़र मैट्रिक्स को कवर करता है। केवल पर्यवेक्षक मोड में — [नियम 14](./docs/reconciliation.md) सर्वोच्च है।
v0.11 पहली npm-प्रकाशित रिलीज़ थी; v0.12.0 एक पूर्ण प्रतिकूल ऑडिट के बाद सुरक्षा को मजबूत करता है — सत्यापनकर्ता द्वारा निर्धारित सहनशीलता सीमाएं (एक रसीद अब अपने स्वयं के पास बैंड को नहीं बढ़ा सकती है), मार्कर-नियंत्रित नियम 14, मल्टी-स्टेप सेल्फ-स्किप बंद, और संसाधन सीमाएं। 792 परीक्षण, 12 विश्वास संबंधी अपरिवर्तनीयताएं। v1.0 अभी भी [वास्तविक दुनिया के उदाहरण + उपयोगकर्ता सत्यापन](#whats-not-in-this-version-yet) पर निर्भर है। उत्पादन में उपयोग करने से पहले [`docs/live-helpers.md`](./docs/live-helpers.md) देखें।
...
backprop-trace v0.12.0 सुरक्षा को मजबूत करता है लेकिन अभी भी **मिड-v0** है। इंजन, पुनर्संयोजक, मानक उत्सर्जन अनुबंध, बाहरी इनपुट पथ और PyTorch लाइव सहायक वास्तविक और स्थिर हैं। नीचे दिया गया रोडमैप उपयोग × सत्यापन-संभावना के क्रम में व्यवस्थित है — प्रत्येक पंक्ति एक बंद-रूप सीपीयू पुनर्गणना पर निर्भर है जिसे पुनर्संयोजक वास्तव में संभाल सकता है:

- **SGD युग्मित-L2 वेट डिके** — प्रलेखित नियम 7 का तीसरा भाग (`grad += lambda*theta` मोमेंटम बफर से पहले)। सबसे अधिक मांग वाला क्षेत्र; बंद-रूप सीपीयू पुनर्गणना। *v0.13.*
- **NAdam (+ वैकल्पिक रूप से RAdam)** — सस्ते Adam वेरिएंट। फिर **LR-शेड्यूल सत्यापन**, जो प्रत्येक ऑप्टिमाइज़र के साथ संयोजन में काम करता है। *v0.14.*
- **वास्तविक दुनिया का उदाहरण** — Mazur 2-2-2 + softmax+CE + sgd_momentum-Mazur आज के हीरो हैं; एक छोटा conv→ReLU→dense नेटवर्क, जो सीपीयू पर बाइट-पुनरुत्पादित किया जा सकता है, v1.0 के लिए आवश्यक है। *v1.0.*
- **उपयोगकर्ता सत्यापन** — अभी तक कोई बाहरी शोधकर्ता केस स्टडी, कोई पाठ्यक्रम अपनाना, या कोई अनुपालन पैकेज उपलब्ध नहीं है। *v1.0 के लिए आवश्यक।*
- **JAX लाइव सहायक** — हाथ से लिखे गए JAX/TF साइडकार पहले से ही नियम 14 के माध्यम से आयात किए जाते हैं; `jax.make_jaxpr(grad)` का उपयोग करने वाला एक लाइव सहायक PyTorch ईगर (सीपीयू + `jax_enable_x64` + पिन किए गए XLA) की तुलना में एक मजबूत विश्वास सीमा प्रदान करता है। *v1.0.*
- **AMSGrad / वैश्विक-नॉर्म ग्रेडिएंट क्लिपिंग / प्रति-समूह LR / Lion** — प्रत्येक एक रसीद/पुनर्संयोजक विस्तार पर निर्भर है। *बाद में।*
- **विषम मल्टी-फ्रेमवर्क ट्रेस** — केवल सिंगल-फ्रेमवर्क बंडल; मिश्रित-फ्रेमवर्क स्ट्रीम समर्थित नहीं हैं। *संभवतः दायरे से बाहर।*
- **कदमों में विषम बैच आकार** — प्रत्येक स्ट्रीम के लिए निश्चित बैच_आकार। *संभवतः दायरे से बाहर।*
- **बैच रसीदों में प्रति-नमूना ग्रेडिएंट** — केवल कम किए गए ग्रेडिएंट आज उपलब्ध हैं; प्रति-नमूना अपघटन प्रभाव ऑडिट के लिए उपयोगी है लेकिन अभी तक उपलब्ध नहीं है। *बाद में।*
- **मल्टी-स्टेप ट्रेस पर उत्पादक-पहचान बंधन** — नियम 17 बंडल अखंडता विफलताओं को पकड़ता है, न कि उत्पादक प्रामाणिकता को। नियम 16 / Sigstore / आउट-ऑफ-बैंड प्रमाणीकरण के साथ मिलाएं। एक ऑपरेटर सतह, अंतर्निहित नहीं।
- **GPU / फ्यूज्ड-कर्नेल बिट-निर्धारण** — दायरे से बाहर और स्थायी। फ्लोटिंग-पॉइंट गैर-सहचर्यता फ्यूज्ड/समानांतर कर्नेल में बिट-सटीकता को प्राप्त करना असंभव बनाती है ([arXiv:2408.05148](https://arxiv.org/abs/2408.05148); cuDNN ConvolutionBackwardFilter एटॉमिक्स के बारे में [CMU SEI](https://www.sei.cmu.edu/blog/the-myth-of-machine-learning-reproducibility-and-randomness-for-acquisitions-and-testing-evaluation-verification-and-validation/)। उत्पाद, नियतात्मक सीपीयू पहलू है।
